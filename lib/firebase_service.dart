...
class FirebaseService {
  ...
  Future<void> updateSchool(String schoolId, Map<String, dynamic> data) async {
    try {
      ...
      throw 'Failed to update school: ${e.toString()}';
    }
  }
  ...
  Future<void> deleteSchool(String schoolId) async {
    try {
      ...
      throw 'Failed to delete school: ${e.toString()}';
    }
  }
  ...
  Future<List<ClassModel>> getClassesBySchool(String schoolId) async {
    try {
      ...
      throw 'Failed to fetch classes: ${e.toString()}';
    }
  }
  ...
  String generateParentFormLink(String schoolId, String classId) {
    return 'https://school-id-management.web.app/#/parent-form/$schoolId/$classId';
  }
